...
const { getQuestion, updateQuestion, breadCrumbList, fetchBreadCrumbList, loading } = useQuestion(indicatorId.value)
  ...
  <div class="p-8 max-w-[1440px] w-full mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-4 fade-in">
      <div class="flex items-center gap-4">
        <button @click="router.back()" class="back-btn flex items-center gap-1 text-white text-sm font-medium bg-primary hover:bg-primary/80 hover:text-primary px-3 py-2 rounded-lg transition-colors text-white text-sm font-medium bg-primary hover:bg-primary/80 hover:text-primary px-3 py-2 rounded-lg transition-colors">
    ...
    <!-- Form Card -->
    <div v-else class="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/10 overflow-hidden fade-in-delay max-w-8xl">
