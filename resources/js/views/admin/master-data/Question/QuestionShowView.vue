          ...
          <div>
            ...
            <div class="flex items-center gap-3">
              <div class="bar w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                <div class="bar-fill h-full bg-[#004592] rounded-full" :style="{ width: (question.weight * 100) + '%' }"></div>
              </div>
              <span class="text-sm font-semibold text-[#004592]">{{ question.weight }}</span>
            </div>
          </div>
        </div>
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <span
              ...
              :class="question.isActive ? 'bg-[#004592]/10 text-[#004592]' : 'bg-slate-100 text-slate-500'"
            >
