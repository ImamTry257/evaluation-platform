...
<template>
  <div class="p-8 max-w-[1440px] w-full mx-auto">
    ...
    <nav class="mb-6 flex items-center gap-2 text-sm">
      <a class="text-[#004592] font-medium hover:underline cursor-pointer" @click="onCancel">Semua Pernyataan</a>      <span class="text-outline">›</span>
    ...
    <div class="flex items-center gap-4 mb-8 fade-in">
      <button
        class="back-btn flex items-center gap-1 text-[#004592] text-sm font-medium hover:bg-[#004592]/10 px-3 py-2 rounded-lg transition-colors"
        @click="onCancel"
      >
